...
def visit_page(note_id):
    with sync_playwright() as playwright:
        ...
        context.add_cookies([{"name": 'flag', "value": 'sctf{I_l0v3_xcsxsxsxsxssxsxsxsxsxsxoop}', "url": 'http://localhost:5000'}])
...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'qwiudg812qef2f276e78912bcu78&*@&**!&#@@uhb8g87wgt28t123'
...
def view_note(note_id):
    ...
    return '<h1>' + note[1] + '</h1><p>' + note[2] + '</p>'
