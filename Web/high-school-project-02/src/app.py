...
def visit_page(note_id):
    with sync_playwright() as playwright:
        ...
        context.add_cookies([{"name": 'flag', "value": 'sctf{{1f_y0u_w4tch3d_l1v3_0v3rf10w_y0u_w0u1d_kn0w}}', "url": 'http://localhost:5000'}])
...
app = Flask(__name__)
app.config['SECRET_KEY'] = ' f3rtv426gv 43t34tv345tv43tv34tb 435gg'
